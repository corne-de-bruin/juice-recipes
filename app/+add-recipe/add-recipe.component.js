...
var add_recipe_service_1 = require('./shared/add-recipe.service');
var AddRecipeComponent = (function () {
    function AddRecipeComponent(addRecipeService) {
    ...
    AddRecipeComponent.prototype.loadIngredients = function () {
        var _this = this;
        this.addRecipeService.loadIngredients().subscribe(function (ingredients) {
    ...
    AddRecipeComponent = __decorate([
        core_1.Component({
            selector: 'jr-home',
            templateUrl: './+add-recipe/add-recipe.component.html',
            providers: [add_recipe_service_1.AddRecipeService]
        }), 
        __metadata('design:paramtypes', [add_recipe_service_1.AddRecipeService])
    ], AddRecipeComponent);
