...
import { AddRecipeService } from './shared/add-recipe.service';
...
export class AddRecipeComponent implements OnInit{
    ...
    public constructor(private addRecipeService: AddRecipeService) {
    ...
    private loadIngredients(): void {
        this.addRecipeService.loadIngredients().subscribe((ingredients: Array<Ingredient>) => {
